  ...
  return (
    <div className='flex  justify-center  w-auto mx-auto h-auto'>
      <div className='flex flex-row-reverse justify-center shadow-xl  w-auto mx-auto items-center my-64'>
        ...
        <form action="" method="post" className='h-auto  mx-auto bg-white px-10 py-10  flex flex-col items-center justify-center'>
              <h1 className='text-center text-gray-500 font-bold text-2xl'>Reset password</h1>
              <p className='text-gray-500 my-4'>Please enter your email or phone number associated with your account</p>
             <div>
                ...
                <div className='flex justify-center mt-2 pt-4'>
                  <input type="submit" value='RESET PASSWORD' className='rounded-full border-gray-500 border-2 text-gray-500 font-bold p-2 text-center cursor-pointer hover:bg-gray-500 hover:text-gray-50 transition duration-100'  />
                </div>
